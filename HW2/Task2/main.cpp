...
int main(int argc, char *argv[])
{
    ...
    timerInnerProduct6.Print("Combine Laplacian with InnerProduct() on line 6 : Time = ");
    timerInnerProduct13.Print("Combine Copy with InnerProduct on line 13 : Time = ");
    ...
    timerSaxpy16b.Print("Combine two Saxpy on line 16 : Time = ");

    timerNorm2.Print("Norm() on line 2 : Time = ");
    timerNorm8.Print("Combine Saxpy with Norm on line 8 : Time = ");

    timerCopy4.Print("Copy() on line 4 : Time = ");
    // timerCopy13.Print("Combine Copy with InnerProduct on line 13 : Time = ");
